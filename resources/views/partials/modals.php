<div id="modal_novo_pedido" style="display: none;" class="fixed inset-0 z-[100] hidden items-center justify-center p-4">
...
<div id="modal_detalhes_pedido" style="display: none;" class="fixed inset-0 z-[100] hidden items-center justify-center p-4">
    <div class="fixed inset-0 bg-black/60 backdrop-blur-sm close-modal-trigger"></div>
    <div class="relative bg-[#0f172a] border border-gray-800 rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-800 flex justify-between items-center">
            <h3 class="text-xl font-bold text-white">Detalhes do Pedido</h3>
            <button type="button" class="text-gray-400 hover:text-white text-2xl close-modal-btn">&times;</button>
        </div>
        <div class="p-6 text-gray-300 modal-body">
        </div>
        <div class="px-6 py-4 border-t border-gray-800 flex justify-end">
            <button type="button" class="bg-gray-800 hover:bg-gray-700 text-white px-6 py-2 rounded-lg transition close-modal-btn">Fechar</button>
        </div>
    </div>
</div>

<div id="modal_feedback" class="fixed inset-0 z-50 hidden flex items-center justify-center bg-black/60 backdrop-blur-sm">

    <div class="bg-[#020617] border border-gray-800 rounded-2xl w-full max-w-md p-6 shadow-xl animate-fade-in">

        <div class="flex justify-center mb-4">
            <div id="modal_feedback_icon"
                class="w-14 h-14 flex items-center justify-center rounded-full text-2xl font-bold">
            </div>
        </div>

        <h2 id="modal_feedback_titulo"
            class="text-center text-lg font-semibold text-white mb-2"></h2>

        <p id="modal_feedback_msg"
            class="text-center text-gray-400 text-sm mb-6"></p>

        <div class="flex justify-center">
            <button id="modal_feedback_btn"
