    ...
    <main class="flex-1 p-8">
        <header class="flex justify-between items-center mb-6">
            <div>
                ...
                <p class="text-gray-400 text-sm"><?= count($clientes) ?> clientes cadastrados</p>
            </div>
                ...
                <div class="bg-card p-6 rounded-2xl border border-gray-800/50 hover:border-cyan-500/30 transition-all duration-300 cliente-card relative group">
                    ...
                    <div class="flex items-center gap-4 mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-xs tracking-tight"><?= $cliente->empresa ?></p>
                        </div>
                    ...
                    <span class="px-3 py-1 rounded-md text-[10px] font-bold uppercase tracking-wider <?= $cliente->status === 'Ativo' ? 'bg-emerald-900/20 text-emerald-500 border border-emerald-800/30' : 'bg-red-900/20 text-red-500 border border-red-800/30' ?>">
                        <?= $cliente->status ?>
                    </span>
                </div>
            <?php endforeach; ?>
